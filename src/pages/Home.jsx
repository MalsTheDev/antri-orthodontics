          ...
          <div className="lg:grid lg:grid-cols-12 lg:gap-12 items-center">
            <div className="lg:col-span-6 space-y-8 animate-fade-in-up">
              ...
              <p className="text-lg text-gray-600 leading-relaxed max-w-2xl">
                Στο ορθοδοντικό ιατρείο της Ανθής Α. Κοντροπούλου, προσφέρουμε σύγχρονες λύσεις για παιδιά και ενήλικες, συνδυάζοντας την επιστημονική αρτιότητα με την προσωπική φροντίδα.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Πραγματικές κριτικές από ανθρώπους που εμπιστεύτηκαν την ορθοδοντική τους φροντίδα στην Ανθή Κοντροπούλου.
            </p>
          </div>
