          ...
          <div className="lg:grid lg:grid-cols-12 lg:gap-12 items-center">
            <div className="lg:col-span-6 space-y-8 animate-fade-in-up">
              ...
              <p className="text-lg text-gray-600 leading-relaxed max-w-2xl">
                Στο ορθοδοντικό ιατρείο της Άντρη Α. Κοντοπούλου, προσφέρουμε σύγχρονες λύσεις για παιδιά και ενήλικες, συνδυάζοντας την επιστημονική αρτιότητα με την προσωπική φροντίδα.
              </p>
            ...
            {[
              {
                ...
                rating: 5,
                text: 'Είχα την ευτυχία να συνεργαστώ με την εξαίρετη ορθοδοντικό κα Κοντοπούλου Άντρη, βάζοντας σιδεράκια στην κόρη μου, με άριστα αποτελέσματα. Εκτός από καταρτισμένη γιατρό, είχαμε και άψογη συνεργασία, γιατί πάνω από όλα ήταν Άνθρωπος. Την ευχαριστώ πολύ!!!!!'
              },
              {
                name: 'Βασιλική Γκόφη',
                when: 'πριν από 3 μήνες',
